...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'doom-modeline
    (set-face-attribute 'tab-bar-tab nil :foreground nil :background nil :inherit 'doom-modeline-bar)
    (set-face-attribute 'tab-bar nil :font "Iosevka Aile" :foreground nil :inherit 'default)
...
#+begin_src emacs-lisp
  ...
  (setup (:pkg keycast)
    ...
    (define-minor-mode keycast-mode
      ...
      :global t
      (setq keycast-window-predicate (lambda () t))
      (if keycast-mode
