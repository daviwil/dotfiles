...
Installs package recipes via =straight.el= by passing the parameter directly to =straight-use-package=.
...
#+begin_src emacs-lisp
  ...
  (setup-define :straight
     ...
     :documentation "Install RECIPE using straight.el"
     :shorthand #'cadr)
...
The =:package= keyword will depend on Guix-installed Emacs packages unless the parameter seems like a =straight.el= recipe (it's a list).
...
This keyword (from the wiki page) causes a setup block to be executed after other packages/features are loaded:
...
#+begin_src emacs-lisp
  ...
  (setup (:package parinfer :guix "emacs-parinfer-mode")
    (:disabled)
...
#+begin_src emacs-lisp
  ...
  (setup (:package origami :guix "emacs-origami-el")
    (:hook-into yaml-mode))
...
#+begin_src emacs-lisp
  ...
  (setup (:package corfu :host github :repo "minad/corfu")
    (:with-map corfu-map
      (:bind "C-j" corfu-next
             "C-k" corfu-previous
             "C-f" corfu-insert))
...
#+begin_src emacs-lisp
  ...
  (setup (:package consult-dir :straight t)
...
#+begin_src emacs-lisp
  ...
  (setup (:package bufler :straight t)
    (:disabled)
...
#+begin_src emacs-lisp
  ...
  (setup (:package auth-source-pass)
    (auth-source-pass-enable))

  (setup (:package oauth2 :straight t))
...
#+begin_src emacs-lisp
  ...
  (setup (:package org-roam :straight t)
...
#+begin_src emacs-lisp
  ...
  (setup (:package git-gutter :straight git-gutter-fringe)
    (:hook-into text-mode prog-mode)
...
#+begin_src emacs-lisp
  ...
  (setup (:package lsp-mode :straight t)
  ...
  (setup (:package lsp-ui :straight t)
    (:hook-into lsp-mode)
    (:when-loaded
     (progn
...
#+begin_src emacs-lisp
  ...
  (setup (:package dap-mode :straight t)
...
#+begin_src emacs-lisp
  ...
  (setup (:package cargo :straight t))
...
#+begin_src emacs-lisp
  ...
  (setup (:package zig-mode :straight t)
    (:disabled)
...
#+begin_src emacs-lisp
  ...
  (setup (:package impatient-mode :straight t))
  (setup (:package skewer-mode :straight t))
...
#+begin_src emacs-lisp
  ...
  (setup (:package command-log-mode :straight t))
...
#+begin_src emacs-lisp
  ...
  (setup (:package obs-websocket :guix "emacs-obs-websocket-el")
...
#+begin_src emacs-lisp
  ...
  (setup (:package hledger-mode :straight t)
    (:bind "TAB" completion-at-point))
...
#+begin_src emacs-lisp
  ...
  (setup (:package erc-hl-nicks)
    (:load-after erc))

  (setup (:package erc-image)
    (:load-after erc))
...
#+begin_src emacs-lisp
  ...
  (setup (:package pulseaudio-control)
