...
(define installation-os-nonfree
  (operating-system
    ...
    (packages
     (append (list exfat-utils fuse-exfat git curl stow vim)
...
This script can be executed remotely using the following command, provided that you have =curl=, =bash=, and =stow= installed:

#+begin_src sh

  curl -s -L https://github.com/daviwil/dotfiles/blob/master/init.sh | bash -

#+end_src

#+begin_src sh :tangle init.sh :shebang #!/bin/sh

  git clone https://github.com/daviwil/dotfiles.git ~/.dotfiles
