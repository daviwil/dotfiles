...
#+BEGIN_SRC emacs-lisp
  ...
  (dw/leader-key-def
    "TAB" '(switch-to-previous-buffer :which-key "swap")
...
I use [[https://www.passwordstore.org/][pass]] to manage all of my passwords locally.  [[https://github.com/ecraven/ivy-pass/][ivy-pass]] automatically pulls
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun dw/set-eshell-aliases ()
    (eshell/alias "edit" "find-file $1")
    (eshell/alias "vim" "find-file $1")
    (eshell/alias "dnu" "sudo dnf update --refresh"))
