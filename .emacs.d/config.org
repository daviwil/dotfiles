...
#+BEGIN_SRC emacs-lisp
  ...
  (defun dw/switch-to-browser-buffer ()
    ...
    (let ((ivy-update-fns-alist
      ...
      (ivy-read "Vimb buffer: " (dw/get-vimb-buffers)
                :keymap ivy-switch-buffer-map
                :action #'ivy--switch-buffer-action
                :caller #'ivy-switch-buffer)))

  (global-set-key (kbd "C-M-j") 'counsel-switch-buffer)
  (global-set-key (kbd "C-M-k") 'dw/switch-to-browser-buffer) ;; TODO: Which binding is best?
  (global-set-key (kbd "C-S-j") 'dw/switch-to-browser-buffer)
